...
//       fechaObjetivo = arguments['fecha_ot'].toString();
...
//   Future<void> _putOrden(
//       String prioridad, String tipoOT, String equipo, String resumen, String fechaObjetivo, bool statusot) async {
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: TextFormField(
                      ...
                      onSaved: (value) {
                        fechaObjetivo = DateTime.parse(value!);
                      },
