          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                final String prioridad = ordentrabajo['prioridad'] ?? 'Baja';
                final Color colorPrioridad = getColorByPriority(prioridad);
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      ...
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                            text: ordentrabajo['estado'] ? '● En proceso'  : '● Terminada',
                            style: TextStyle(
                              fontSize: 12,
                              color: ordentrabajo['estado'] ? Color.fromARGB(255, 219, 140, 37) : Colors.green,
                            ),
                          ),
                        ],
                      ),
                      ...
                      onTap: () {
                        Navigator.pushNamed(context, 'ordentrabajositem',
                            arguments: {
                              'id_ot': ordentrabajo['id'],
                              'cod_ot': ordentrabajo['cod_ot'],
                              'prioridad_ot': ordentrabajo['prioridad'],
